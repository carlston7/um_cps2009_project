...
from restaurant_review.models import Court, Review

# Create your views here.

def index(request):
    print('Request for index page received')
    restaurants = Court.objects.annotate(avg_rating=Avg('review__rating')).annotate(review_count=Count('review'))
...
def details(request, id):
    ...
    restaurant = get_object_or_404(Court, pk=id)
...
def create_restaurant(request):
    ...
    return render(request, 'restaurant_review/create_court.html')
